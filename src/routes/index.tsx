		...
		<div className="flex min-h-screen flex-col bg-background text-foreground font-sans">
			...
			<section className="container mx-auto px-4 py-20 text-center md:py-32">
				...
				<p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground md:text-xl">
					A web app that helps travelers create day-by-day itineraries,
					visualize optimized routes on maps, and organize documents securely
					with full offline access.
				</p>
			...
			<section className="container mx-auto px-4 py-20">
				<div className="rounded-2xl bg-primary/5 p-8 md:p-12 lg:p-16 text-center">
					...
					<p className="mx-auto mb-8 max-w-3xl text-lg text-muted-foreground">
						Your trips, your documents, your data stored locally. Perfect for
						your trips. Focus on experiences, not logistics.
					</p>
				</div>
			</section>
			...
			<footer className="bg-background py-8 border-t border-border">
				<div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
					&copy; {new Date().getFullYear()} Itinerary Planner. All rights
					reserved.
				</div>
			</footer>
		</div>
